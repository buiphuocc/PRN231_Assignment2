...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    private string GetConnectionString()
    {
        ...
        var connection = configuration.GetConnectionString("SilverJewelryDB");
        return connection;
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BranchAc__349DA586A68304A5");

            entity.ToTable("BranchAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__BranchAc__49A14740C030038D").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B68031A3E");
        ...
        {
            entity.HasKey(e => e.SilverJewelryId).HasName("PK__SilverJe__1F127197A7964C96");
